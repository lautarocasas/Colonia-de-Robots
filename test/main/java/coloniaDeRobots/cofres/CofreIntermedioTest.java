...
class CofreIntermedioTest {
	...
	void configurar() {
		...
		intermedio = new CofreIntermedio(new Ubicacion(0, 0), inventario, solicitudes);
	...
	void registraSolicitudInicial() {
		...
		assertEquals(2, pendientes.get(0).getCantidadPendiente(), "Cantidad pendiente debe ser 2");
	}
